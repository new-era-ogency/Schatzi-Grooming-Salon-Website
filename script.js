...
const translations = {
  de: {
    ...
    teamTitle: "Ihre zertifizierte Master-Groomerin.",
    teamCopy: "Krotenko Alina steht für ruhige Behandlung, Premium-Pflege und präzise Fellästhetik.",
  ...
  en: {
    ...
    teamTitle: "Your certified master groomer.",
    teamCopy: "Krotenko Alina brings calm handling, premium care, and precise coat aesthetics.",
    socialKicker: "Social Proof",
  ...
  uk: {
    ...
    teamTitle: "Ваша сертифікована майстриня грумінгу.",
    teamCopy: "Krotenko Alina поєднує спокійний підхід, преміальний догляд і точну естетику шерсті.",
  ...
  ru: {
    ...
    teamTitle: "Ваш сертифицированный мастер груминга.",
    teamCopy: "Krotenko Alina сочетает спокойный подход, премиальный уход и точную эстетику шерсти.",
  ...
  pl: {
    ...
    teamTitle: "Twoja certyfikowana master groomerka.",
    teamCopy: "Krotenko Alina łączy spokojne podejście, pielęgnację premium i precyzyjną estetykę sierści.",
    socialKicker: "Social proof",
    socialTitle: "Live from @schatzi.groomingsalon",
    contactKicker: "Kontakt",
